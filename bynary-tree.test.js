const { BinaryTree, BinaryTreeNode } = require("./bynary-tree");

describe("Binary Tree", function() {
  it("functions_exist", function() {
    expect(typeof BinaryTree === "function").toBe(true);
    expect(typeof BinaryTreeNode === "function").toBe(true);
  });

  it("creates_binary_tree", function() {
...
function TreeNode(val) {
  ...
  module.exports = { TreeNode, lowestCommonAncestor, lowestCommonAncestorShorthand };
